...
export const { handlers, auth, signIn, signOut } = NextAuth({
  ...
  callbacks: {
    authorized({ auth: session, request: { nextUrl } }) {
      ...
      const publicPaths = ["/", "/pricing", "/auth", "/dashboard", "/account", "/blog", "/about", "/changelog", "/feedback", "/admin", "/terms", "/privacy", "/support", "/train", "/roast", "/analyze", "/openings", "/my-openings", "/dungeon", "/guess", "/leaderboard", "/shop", "/chaos", "/escape"];
      const isPublic =
