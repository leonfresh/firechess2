...
export const ALL_ANOMALIES: AnomalyDefinition[] = [
  ...
  /* XV — The Devil */
  {
    ...
    tarotRoman: "XV",
    tarotName: "The Devil",
    name: "Pitchfork Pawns",
    description:
      "Your pawns can also capture 1 square straight ahead. Bayonet is built in and removed from your draft pool.",
    icon: "😈",
    trigger: "passive",
    injectModifiers: ["pawn-capture-forward"],
    removesFromDraft: ["pawn-capture-forward"],
    bgGradient: "from-red-950/90 to-rose-900/50",
