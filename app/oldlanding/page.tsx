          ...
          >
            ...
            >
              ...
              <div className="relative mt-6 flex flex-col gap-4">
                <div
                  className={`flex flex-col overflow-hidden rounded-2xl border bg-white/[0.04] transition-colors duration-200 focus-within:border-orange-400/35 sm:flex-row sm:items-center ${
                    !source
