...
const EVENTS = new Set(["lobby_view", "practice_start", "queue_start", "queue_cancel", "wait_ai", "invite", "match_found", "tutorial_start", "tutorial_done", "shop_offer_seen", "shop_offer_bought"]);
