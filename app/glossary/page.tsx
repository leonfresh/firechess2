...
function IndexJsonLd() {
  ...
  const definedTermSet = {
    ...
    name: "Chess Glossary",
    description:
      "Definitions of chess terms: tactics, strategy, endgame, openings, and concepts",
    url: `${base}/glossary`,
...
export default function GlossaryIndexPage() {
  const byCategory = CATEGORY_ORDER.reduce<
    Record<GlossaryCategory, GlossaryTerm[]>
  >(
    (acc, cat) => {
        ...
        <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <header className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-xl text-slate-400">
              Every chess term explained clearly — from your first fork to the
              Lucena position. {GLOSSARY_TERMS.length} terms with definitions,
              examples, and why each matters.
            </p>
          </header>
          ...
          <section className="mt-4 rounded-xl border border-orange-500/30 bg-gradient-to-r from-orange-500/10 to-red-500/10 p-8 text-center">
            ...
            <p className="mb-6 text-slate-400">
              FireChess finds forks, pins, and missed tactical patterns in your
              real games — then shows you exactly how to spot them next time.
            </p>
            <Link
              href="/analyze"
