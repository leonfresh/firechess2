...
export function ModernDashboard({ demo = false }: { demo?: boolean }) {
  ...
  return <div className={s.root}><PreviewHeader /><div className={s.dashboardContainer}>
    ...
    {demo && <div className={s.accessNote}><p>Sample dashboard · public player reports. These are examples, not your saved reports.</p><Link href="/newdashboard">Back to my dashboard →</Link></div>}
