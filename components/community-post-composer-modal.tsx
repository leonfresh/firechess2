...
export function CommunityPostComposerModal({
  ...
  return (
    ...
    >
      <div
        className="mx-auto flex h-full w-full max-w-5xl flex-col overflow-hidden rounded-[2rem] border border-[#1e1a24] bg-[#030712] shadow-[0_40px_120px_rgba(0,0,0,0.55)]"
