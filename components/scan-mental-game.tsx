...
function HelpTip({ text }: { text: string }) {
  return (
    <span className="group relative ml-1 inline-flex">
      <span className="flex h-[15px] w-[15px] cursor-help items-center justify-center rounded-full border border-[color:var(--report-line,#1e1a24)] bg-[color:var(--report-panel,rgba(255,90,31,0.05))] text-[length:var(--report-small,9px)] font-bold leading-none text-[color:var(--report-muted,#565061)] transition-colors group-hover:border-emerald-500/30 group-hover:bg-emerald-500/10 group-hover:text-emerald-400">
        ?
      </span>
      <span className="pointer-events-none absolute bottom-full left-1/2 z-[9999] mb-2 w-48 -translate-x-1/2 rounded-lg border border-[color:var(--report-line,#1e1a24)] bg-slate-900/95 px-3 py-2 text-[length:var(--report-small,11px)] font-normal normal-case leading-snug tracking-normal text-[color:var(--report-text,#f0edf2)] opacity-0 shadow-xl backdrop-blur-sm transition-opacity group-hover:opacity-100">
        {text}
...
export function MentalGameLoading() {
  return (
    <div className="relative overflow-hidden rounded-[var(--report-radius,1rem)] border border-[color:var(--report-line,#1e1a24)] p-6 md:p-8">
      ...
      <div className="relative">
        ...
        <p className="mt-1 text-xs text-[color:var(--report-muted,#565061)]">
          ...
          {[1, 2, 3].map((index) => (
            ...
            >
              <div className="flex gap-4">
                <div className="h-16 w-16 shrink-0 rounded-[var(--report-radius,0.75rem)] bg-[color:var(--report-surface,#1e1a24)]" />
                <div className="flex-1 space-y-2 pt-1">
                  <div className="h-3.5 w-3/4 rounded bg-[color:var(--report-surface,#1e1a24)]" />
                  <div className="h-3 w-1/2 rounded bg-[color:var(--report-surface,#1e1a24)]" />
                  <div className="h-3 w-2/3 rounded bg-[color:var(--report-surface,#1e1a24)]" />
                </div>
              </div>
            </div>
          ))}
          <p className="text-center text-xs text-[color:var(--report-muted,#565061)]">
...
export function ScanMentalGame({
  ...
  return (
    <div className="relative overflow-hidden rounded-[var(--report-radius,1rem)] border border-[color:var(--report-line,#1e1a24)] p-6 md:p-8">
      ...
      <div className="pointer-events-none absolute -right-20 -top-20 h-40 w-40 rounded-full bg-[color:var(--report-panel,rgba(255,90,31,0.08))] blur-[60px]" />
      <div className="pointer-events-none absolute -bottom-20 -left-20 h-40 w-40 rounded-full bg-[color:var(--report-panel,rgba(255,90,31,0.08))] blur-[60px]" />

      <div className="relative">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-xl font-bold text-white">Mental Game</h2>
          <div className="flex flex-wrap gap-2">
            <span className="inline-flex items-center gap-1 rounded-full border border-[#ff5a1f]/25 bg-[color:var(--report-panel,rgba(255,90,31,0.06))] px-3 py-1 text-xs font-medium text-[color:var(--report-accent-text,#ff8c42)]">
              🧠 Psychology
            </span>
            <span className="inline-flex items-center gap-1 rounded-full border border-slate-500/20 bg-slate-500/[0.08] px-3 py-1 text-xs font-medium text-[color:var(--report-muted,#8d8696)]">
          ...
          {[
            ...
            <div key={stat.label} className="stat-card">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[length:var(--report-small,11px)] font-medium uppercase tracking-wider text-[color:var(--report-muted,#565061)]">
                  {stat.label}
        ...
        {hasProAccess ? (
          <>
            <div className="mt-5 flex flex-wrap items-center gap-3">
              {mentalStats.archetype ? (
                <span className="inline-flex items-center gap-1.5 rounded-full border border-[#ff5a1f]/25 bg-[color:var(--report-panel,rgba(255,90,31,0.1))] px-4 py-1.5 text-sm font-semibold text-[color:var(--report-accent-text,#ff8c42)]">
                  {mentalStats.archetype}
                </span>
              ) : null}
              {mentalStats.recentForm && mentalStats.recentForm.length > 0 ? (
                <div className="flex items-center gap-1">
                  <span className="mr-1 text-[length:var(--report-small,10px)] font-medium uppercase tracking-wider text-[color:var(--report-muted,#565061)]">
                    Last {mentalStats.recentForm.length}
                  </span>
                  {mentalStats.recentForm.map((result, index) => (
                    <span
                      key={`${result}-${index}`}
                      className={`flex h-5 w-5 items-center justify-center rounded text-[length:var(--report-small,10px)] font-bold ${
                        result === "W"
                          ? "bg-emerald-500/20 text-emerald-400"
                          : result === "L"
                            ? "bg-red-500/20 text-red-400"
                            : "bg-slate-500/20 text-[color:var(--report-muted,#8d8696)]"
                      }`}
                    >
                      {result}
                    </span>
            ...
            <div className="mt-4">
              <p className="mb-2 text-[length:var(--report-small,10px)] font-medium uppercase tracking-wider text-[color:var(--report-muted,#565061)]">
                Color Performance
              </p>
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="flex items-center gap-3 rounded-[var(--report-radius,0.75rem)] border border-[color:var(--report-line,#1e1a24)] bg-[color:var(--report-panel,rgba(255,90,31,0.03))] px-3.5 py-3">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#ff5a1f]/10 text-sm">
                    ♔
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-[color:var(--report-muted,#8d8696)]">
                        White · {mentalStats.whiteGames ?? 0} games
                      </span>
                      <span
                        className={`text-sm font-bold ${(mentalStats.whiteWinRate ?? 0) >= 55 ? "text-emerald-400" : (mentalStats.whiteWinRate ?? 0) >= 45 ? "text-[color:var(--report-accent-text,#ff8c42)]" : "text-red-400"}`}
                      >
                        {mentalStats.whiteWinRate ?? 0}%
                      </span>
                    </div>
                    <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-[color:var(--report-surface,#1e1a24)]">
                      <div
                ...
                <div className="flex items-center gap-3 rounded-[var(--report-radius,0.75rem)] border border-[color:var(--report-line,#1e1a24)] bg-[color:var(--report-panel,rgba(255,90,31,0.03))] px-3.5 py-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`text-sm font-bold ${(mentalStats.blackWinRate ?? 0) >= 55 ? "text-emerald-400" : (mentalStats.blackWinRate ?? 0) >= 45 ? "text-[color:var(--report-accent-text,#ff8c42)]" : "text-red-400"}`}
                      >
                  ...
                  },
                  {
                    ...
                    color:
                      (mentalStats.mateFinishRate ?? 0) >= 40
                        ...
                        : (mentalStats.mateFinishRate ?? 0) >= 20
                          ? "text-[color:var(--report-accent-text,#ff8c42)]"
                          : "text-[color:var(--report-muted,#8d8696)]",
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2">
              <div className="stat-card">
                ...
                <p
                  className={`mt-1 text-2xl font-bold ${(mentalStats.decisiveness ?? 0) >= 85 ? "text-[color:var(--report-accent-text,#ff8c42)]" : "text-[color:var(--report-accent-text,#ff8c42)]"}`}
                >
                  {mentalStats.decisiveness ?? 0}%
                </p>
                <p
                  className={`mt-0.5 text-xs opacity-70 ${(mentalStats.decisiveness ?? 0) >= 85 ? "text-[color:var(--report-accent-text,#ff8c42)]" : "text-[color:var(--report-accent-text,#ff8c42)]"}`}
                >
              ...
              <div className="stat-card">
                ...
                <p className="mt-1 text-2xl font-bold text-[color:var(--report-text,#f0edf2)]">
                  {mentalStats.drawRate ?? 0}%
                </p>
                <p className="mt-0.5 text-xs text-[color:var(--report-muted,#8d8696)] opacity-70">
          ...
          <div className="relative mt-5">
                ...
                <div className="flex items-center gap-3 rounded-[var(--report-radius,0.75rem)] border border-[color:var(--report-line,#1e1a24)] bg-[color:var(--report-panel,rgba(255,90,31,0.03))] px-3.5 py-3">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-bold text-[color:var(--report-accent-text,#ff8c42)]">
                        47.2%
                      </span>
                    </div>
                    <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-[color:var(--report-surface,#1e1a24)]">
                ...
                {["Avg Win Len", "Avg Loss Len", "Best Run", "Worst Run"].map(
                  (label) => (
                    <div key={label} className="stat-card">
                      ...
                      <p className="mt-1 text-2xl font-bold text-[color:var(--report-accent-text,#ff8c42)]">
                        28
                      </p>
                      <p className="mt-0.5 text-xs text-[color:var(--report-accent-text,#ff8c42)] opacity-70">
                        moves
                      </p>
                    </div>
                  ),
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <div className="rounded-[var(--report-radius,1rem)] border border-[#ff5a1f]/25 bg-slate-900/90 px-6 py-4 text-center shadow-2xl backdrop-blur-sm">
                <p className="text-lg font-bold text-white">
                  🔒 Pro Mental Breakdown
                </p>
                <p className="mt-1.5 max-w-xs text-xs text-[color:var(--report-muted,#8d8696)]">
                ...
                <a
                  href="/pricing"
                  className="mt-3 inline-flex items-center gap-1.5 rounded-[var(--report-radius,0.75rem)] bg-[#ff5a1f] px-5 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#ff5a1f]"
                >
                  Upgrade to Pro
                </a>
              </div>
        ...
        <div className="mt-4">
          <p className="text-xs text-[color:var(--report-muted,#565061)]">
